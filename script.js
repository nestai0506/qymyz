...
const I18N = {
  ...
  wa_intro:        { kz:"Сәлеметсіз бе! Мен мына тауарларға тапсырыс бергім келеді:", ru:"Здравствуйте! Я хочу заказать следующие товары:", en:"Hello! I would like to order the following:" },
