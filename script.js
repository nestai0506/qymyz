...
const I18N = {
  ...
  // «құю» метафорасы қазақшада табиғи естіледі; орысша/ағылшыншада
  // мәжбүрлемей, әдеттегі нұсқасын қалдырдық (әйтпесе оғаш шығады).
  add_to_cart:     { kz:"Себетке құю", ru:"В корзину", en:"Add to cart" },
  added_ok:        { kz:"Құйылды", ru:"Готово", en:"Added" },
  ...
  toast_added:     { kz:" себетке құйылды", ru:" добавлен в корзину", en:" added to cart" },
